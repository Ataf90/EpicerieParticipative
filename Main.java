...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ProduitAlimentaire vinBioAvecReduction = new ProduitAlimentaire(20,15); //Vente avec réductionde 15%
        ...
        if(Epicerie.chiffreAffaires > 100){
            System.out.println("Le chiffre d'affaire est de:" + Epicerie.chiffreAffaires + "€");
        } else {
